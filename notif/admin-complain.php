...
<head>
	...
	<link href="https://cdn.jhttp://localhost/pkl/komentar/index.phpsdelivr.net/npm/bootstrap@5.1.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous" />
...
<body>
	...
	<div class="container mb-3">
		<h2 align="center" style="margin: 60px 10px 10px 10px;">TEST KOMENTAR</h2>
		<hr>

		<!--<form method="POST" id="form_komen" name="Contact-Form">
			<div class="form-group">
				<input type="hidden" name="user_id" id="user_id" value=<?php echo $_SESSION['id']; ?> />
				<input type="hidden" name="nama_pengirim" id="nama_pengirim" Value=<?php echo $_SESSION['username']; ?> class="form-control" placeholder="Masukkan Nama" />
			</div>
