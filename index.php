            ...
            <div class="row">
                ...
                ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 pt-4">
                        <h5 class="product-title"><?php echo $row["title_prod"]; ?> </h5>
                        <div class="card">
                            <img src="<?php echo $row["images"]; ?>" class="card-img-top" alt="Picture" title="Remove Pattern Lock Screen & Bypass FRP Vivo Y91 (PD1818CF)" loading="lazy">
                            <figcaption class="figure-caption "><?php echo $row["subtitle_prod"]; ?></figcaption>
                        </div>
                    </div>
    ...
    <section id="Footer">
        ...
        <div class="container ">
            <div class="row ">
                ...
                <div class="col-md-3 footer-box pl-4 ">
                ...
                <div class="col-md-3 footer-box mb-4">
                    <h5>CONTRIBUTOR</h5>
                    <a href="https://www.instagram.com/angelcalliista/">
                        <P>Angel Callista Pramadio</P>
                    </a>
                    <a href="https://www.instagram.com/zannawildan/">
                        <P>M.Wildan Mukholadun Saujana</p>
                    </a>
                    <a href="https://www.instagram.com/_fahregi/">
                        <P>Mohammad Faisal Fahregi </p>
                    </a>
                    <a href="https://www.instagram.com/msthf_hnf/">
                        <P>Musthafa Hanif</p>
                    </a>
                    <a href="https://www.instagram.com/shanazsiva/">
                        <P>Shanazsiva Nasra</p>
                    </a>
                    <a href="https://www.instagram.com/wa.yannn/">
                        <P>Wayan Abdinasshalihin</p>
                    </a>
                </div>
                <div class="col-md-3 footer-box ">
                    <h4>COMPLAIN</h4>
